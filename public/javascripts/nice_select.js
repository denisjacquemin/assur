 ...
 *--------------------------------------------------------------------------*/
 var NiceSelect = Class.create({
      ...
      initialize: function(selectElement, label, options) {
        ...
        this.selectTag.options.add(newOption);
      ...
      actOnChange: function(event) {
          ...
          var newOptionValue = 'new#' + this.selectTag.select('option').length + '#' + newLabel;
